...
(20, '分销通知', 'commission', NULL, NULL, NULL, NULL, 'commission', '分销消息通知', 0),
...
(60, '成为会员通知', 'globonus_become', 'OPENTM207574677', '', '业务处理通知', '{{first.DATA}}业务类型：{{keyword1.DATA}}业务状态：{{keyword2.DATA}}业务内容：{{keyword3.DATA}}{{remark.DATA}}', 'globonus', '会员消息通知', 0),
(61, '会员等级升级通知', 'globonus_upgrade', 'OPENTM207574677', '', '业务处理通知', '{{first.DATA}}业务类型：{{keyword1.DATA}}业务状态：{{keyword2.DATA}}业务内容：{{keyword3.DATA}}{{remark.DATA}}', 'globonus', '会员消息通知', 0),
(62, '分红发放通知', 'globonus_pay', 'OPENTM207574677', '', '业务处理通知', '{{first.DATA}}业务类型：{{keyword1.DATA}}业务状态：{{keyword2.DATA}}业务内容：{{keyword3.DATA}}{{remark.DATA}}', 'globonus', '会员消息通知', 0),
...
(3, 3, 'commission', 'biz', '分销', '1.0', '官方', 1, '../addons/ewei_shopv2/static/images/commission.jpg', '', 0, 0, 0),
...
(20, 22, 'globonus', 'biz', '全民会员', '1.0', '官方', 1, '../addons/ewei_shopv2/static/images/globonus.jpg', '', 0, 0, 0),
...
(46, 50, 'pc', 'tool', 'PC端', '1.0', '二开', 1, '../addons/ewei_shopv2/static/images/pc.jpg', '', 0, 0, 0),
(47, 51, 'cycelbuy', 'biz', '周期购', '1.0', '官方', 1, '../addons/ewei_shopv2/static/images/cycelbuy.jpg', '', 0, 0, 1);
