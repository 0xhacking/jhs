...
class Index_EweiShopV2Page extends PluginWebPage
{
    public function main()
    {
        ...
        if ( cv("commission.weekglons")) {
            header("location: " . webUrl("commission/weekglons"));
            exit();
        }
        if ( cv("commission.monthglons")) {
            header("location: " . webUrl("commission/monthglonsset"));
            exit();
        }
        if ( cv("commission.zoneset")) {
            header("location: " . webUrl("commission/zoneset"));
            exit();
        }
