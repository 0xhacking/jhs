		...
		public function getInfo($openid, $options = NULL)
		{
			...
			if (1 <= $level) {
				...
				if (in_array('total', $options)) {
					...
					$level1_commissions = pdo_fetchall('select og.commission1,og.commissions,og.commissionlead  from ' . tablename('ewei_shop_order_goods') . ' og ' . ' left join  ' . tablename('ewei_shop_order') . ' o on o.id = og.orderid' . ' where o.agentid=:agentid and o.status>=1 and og.nocommission=0 and o.uniacid=:uniacid', array(':uniacid' => $_W['uniacid'], ':agentid' => $member['id']));
					...
					foreach ($level1_commissions as $c ) {
						...
						if (empty($commissions)) {
							...
							$commission_total += floatval ($commissionlead['level1'])
						}
				...
				if (in_array('ok', $options)) {
					...
					$level1_commissions = pdo_fetchall('select og.commission1,og.commissions,og.commissionlead  from ' . tablename('ewei_shop_order_goods') . ' og ' . ' left join  ' . tablename('ewei_shop_order') . ' o on o.id = og.orderid' . ' where o.agentid=:agentid and o.status>=3 and og.nocommission=0 and (' . $time . ' - o.finishtime > ' . $day_times . ') and og.status1=0  and o.uniacid=:uniacid', array(':uniacid' => $_W['uniacid'], ':agentid' => $member['id']));
					...
					foreach ($level1_commissions as $c ) {
						...
						if (empty($commissions)) {
							...
							$commission_ok += $commissionlead['level1'];
						}
				...
				if (in_array('lock', $options)) {
					...
					$level1_commissions1 = pdo_fetchall('select og.commission1,og.commissions,og.commissionlead  from ' . tablename('ewei_shop_order_goods') . ' og ' . ' left join  ' . tablename('ewei_shop_order') . ' o on o.id = og.orderid' . ' where o.agentid=:agentid and o.status>=3 and og.nocommission=0 and (' . $time . ' - o.finishtime <= ' . $day_times . ')  and og.status1=0  and o.uniacid=:uniacid', array(':uniacid' => $_W['uniacid'], ':agentid' => $member['id']));
					...
					foreach ($level1_commissions1 as $c ) {
						...
						if (empty($commissions)) {
							...
							$commission_lock += $commissionlead['level1'];
						}
				...
				if (in_array('apply', $options)) {
					...
					$level1_commissions2 = pdo_fetchall('select og.commission1,og.commissions,og.commissionlead  from ' . tablename('ewei_shop_order_goods') . ' og ' . ' left join  ' . tablename('ewei_shop_order') . ' o on o.id = og.orderid' . ' where o.agentid=:agentid and o.status>=3 and og.status1=1 and og.nocommission=0 and o.uniacid=:uniacid', array(':uniacid' => $_W['uniacid'], ':agentid' => $member['id']));
					...
					foreach ($level1_commissions2 as $c ) {
						...
						if (empty($commissions)) {
							...
							$commission_apply += $commissionlead['level1'];
						}
				...
				if (in_array('check', $options)) {
					...
					$level1_commissions2 = pdo_fetchall('select og.commission1,og.commissions,og.commissionlead  from ' . tablename('ewei_shop_order_goods') . ' og ' . ' left join  ' . tablename('ewei_shop_order') . ' o on o.id = og.orderid' . ' where o.agentid=:agentid and o.status>=3 and og.status1=2 and og.nocommission=0 and o.uniacid=:uniacid ', array(':uniacid' => $_W['uniacid'], ':agentid' => $member['id']));
					...
					foreach ($level1_commissions2 as $c ) {
						...
						if (empty($commissions)) {
							...
							$commission_check += $commissionlead['level1'];
						}
				...
				if (in_array('pay', $options)) {
					...
					$level1_commissions2 = pdo_fetchall('select og.commission1,og.commissions,og.commissionlead  from ' . tablename('ewei_shop_order_goods') . ' og ' . ' left join  ' . tablename('ewei_shop_order') . ' o on o.id = og.orderid' . ' where o.agentid=:agentid and o.status>=3 and og.status1=3 and og.nocommission=0 and o.uniacid=:uniacid ', array(':uniacid' => $_W['uniacid'], ':agentid' => $member['id']));
					...
					foreach ($level1_commissions2 as $c ) {
						...
						if (empty($commissions)) {
							...
							$commission_pay += $commissionlead['level1'];
						}
				...
				if (in_array('wait', $options)) {
					...
					$level1_commissions2 = pdo_fetchall('select og.commission1,og.commissions,og.commissionlead  from ' . tablename('ewei_shop_order_goods') . ' og ' . ' left join  ' . tablename('ewei_shop_order') . ' o on o.id = og.orderid' . ' where o.agentid=:agentid and (o.status=2 or o.status=1) and og.status1=0  and og.nocommission=0 and o.uniacid=:uniacid ', array(':uniacid' => $_W['uniacid'], ':agentid' => $member['id']));
					...
					foreach ($level1_commissions2 as $c ) {
						...
						if (empty($commissions)) {
							...
							$commission_wait += $commissionlead['level1'];
						}
				...
				if (in_array('fail', $options)) {
					...
					foreach ($level1_commissions2 as $c ) {
						...
						if (empty($commissions)) {
							...
							$commission_fail += $commissionlead['level1'];
						}
			...
			if (2 <= $level) {
				...
				if (0 < $level1) {
					...
					if (in_array('total', $options)) {
						...
						$level2_commissions = pdo_fetchall('select og.commission2,og.commissions,og.commissionlead from ' . tablename('ewei_shop_order_goods') . ' og ' . ' left join  ' . tablename('ewei_shop_order') . ' o on o.id = og.orderid ' . ' where o.agentid in( ' . implode(',', array_keys($level1_agentids)) . ')  and o.status>=1 and og.nocommission=0 and o.uniacid=:uniacid', array(':uniacid' => $_W['uniacid']));
						...
						foreach ($level2_commissions as $c ) {
							...
							if (empty($commissions)) {
								...
								$commission_total += $commissionlead['level2'];
							}
					...
					if (in_array('ok', $options)) {
						...
						foreach ($level2_commissions as $c ) {
							...
							if (empty($commissions)) {
								...
								$commission_ok += $commissionlead['level2'];
							}
					...
					if (in_array('lock', $options)) {
						...
						$level2_commissions1 = pdo_fetchall('select og.commission2,og.commissions,og.commissionlead  from ' . tablename('ewei_shop_order_goods') . ' og ' . ' left join  ' . tablename('ewei_shop_order') . ' o on o.id = og.orderid ' . ' where o.agentid in( ' . implode(',', array_keys($level1_agentids)) . ')  and (' . $time . ' - o.finishtime <= ' . $day_times . ') and og.status2=0 and o.status>=3 and og.nocommission=0 and o.uniacid=:uniacid', array(':uniacid' => $_W['uniacid']));
						...
						foreach ($level2_commissions1 as $c ) {
							...
							if (empty($commissions)) {
								...
								$commission_lock += $commissionlead['level2'];
							}

						}
					}
					if (in_array('apply', $options)) {
						$level2_commissions2 = pdo_fetchall('select og.commission2,og.commissions,og.commissionlead  from ' . tablename('ewei_shop_order_goods') . ' og ' . ' left join  ' . tablename('ewei_shop_order') . ' o on o.id = og.orderid ' . ' where o.agentid in( ' . implode(',', array_keys($level1_agentids)) . ')  and o.status>=3 and og.status2=1 and og.nocommission=0 and o.uniacid=:uniacid', array(':uniacid' => $_W['uniacid']));
						foreach ($level2_commissions2 as $c ) {
							...
							if (empty($commissions)) {
								...
								$commission_apply += $commissionlead['level2'];
							}
						}
					}
					if (in_array('check', $options)) {
						$level2_commissions3 = pdo_fetchall('select og.commission2,og.commissions,og.commissionlead  from ' . tablename('ewei_shop_order_goods') . ' og ' . ' left join  ' . tablename('ewei_shop_order') . ' o on o.id = og.orderid ' . ' where o.agentid in( ' . implode(',', array_keys($level1_agentids)) . ')  and o.status>=3 and og.status2=2 and og.nocommission=0 and o.uniacid=:uniacid', array(':uniacid' => $_W['uniacid']));
						foreach ($level2_commissions3 as $c ) {
							...
							if (empty($commissions)) {
								...
								$commission_check += $commissionlead['level2'];
							}
						}
					}
					if (in_array('pay', $options)) {
						...
						foreach ($level2_commissions3 as $c ) {
							...
							if (empty($commissions)) {
								...
								$commission_pay += $commissionlead['level2'];
							}
					...
					if (in_array('wait', $options)) {
						...
						foreach ($level2_commissions3 as $c ) {
							...
							if (empty($commissions)) {
								...
								$commission_wait += $commissionlead['level2'];
							}
					...
					if (in_array('fail', $options)) {
						...
						foreach ($level2_commissions3 as $c ) {
							...
							if (empty($commissions)) {
								...
								$commission_fail += $commissionlead['level2'];
							}
			...
			if (3 <= $level) {
				...
				if (0 < $level2) {
					...
					if (in_array('total', $options)) {
						...
						$level3_commissions = pdo_fetchall('select og.commission3,og.commissions,og.commissionlead  from ' . tablename('ewei_shop_order_goods') . ' og ' . ' left join  ' . tablename('ewei_shop_order') . ' o on o.id = og.orderid' . ' where o.agentid in( ' . implode(',', array_keys($level2_agentids)) . ')  and o.status>=1 and og.nocommission=0 and o.uniacid=:uniacid', array(':uniacid' => $_W['uniacid']));
						...
						foreach ($level3_commissions as $c ) {
							...
							if (empty($commissions)) {
								...
								$commission_total += $commissionlead['level3'];
							}
					...
					if (in_array('ok', $options)) {
						...
						foreach ($level3_commissions as $c ) {
							...
							if (empty($commissions)) {
								...
								$commission_ok += $commissionlead['level3'];
							}
					...
					if (in_array('lock', $options)) {
						...
						foreach ($level3_commissions1 as $c ) {
							...
							if (empty($commissions)) {
								...
								$commission_lock += $commissionlead['level3'];
							}
					...
					if (in_array('apply', $options)) {
						...
						foreach ($level3_commissions2 as $c ) {
							...
							if (empty($commissions)) {
								...
								$commission_apply += $commissionlead['level3'];
							}
					...
					if (in_array('check', $options)) {
						...
						foreach ($level3_commissions3 as $c ) {
							...
							if (empty($commissions)) {
								...
								$commission_check += $commissionlead['level3'];
							}
					...
					if (in_array('pay', $options)) {
						...
						foreach ($level3_commissions3 as $c ) {
							...
							if (empty($commissions)) {
								...
								$commission_pay += $commissionlead['level3'];
							}
					...
					if (in_array('wait', $options)) {
						...
						foreach ($level3_commissions3 as $c ) {
							...
							if (empty($commissions)) {
								...
								$commission_wait += $commissionlead['level3'];
							}
					...
					if (in_array('fail', $options)) {
						...
						foreach ($level3_commissions3 as $c ) {
							...
							if (empty($commissions)) {
								...
								$commission_fail += $commissionlead['level3'];
							}
